package  
{
	...
	The TurtleRandom takes in another parameter for perturbing the angle.
	*/
	public class TurtleRandom extends Sprite
	{
		...
		private var randomAngleMagnitude: Number;
		...
		thisStage:DisplayObjectContainer = object to contain constructor
		   ...
		   randomAngleMagnitude         = how much of a random angle to turn by
		...
		*/
		public function TurtleRandom(thisStage:DisplayObjectContainer,
							   startX: 								int, 
							   startY: 								int, 
							   ...
							   randomAngleMagnitudeParameter:       Number) 
		{
			...
			randomAngleMagnitude = randomAngleMagnitudeParameter;
		...
		*/
		public function create_display_list():void
		{
			...
			directionVector.rotateVector(turnAngle * Math.random() * randomAngleMagnitude );
